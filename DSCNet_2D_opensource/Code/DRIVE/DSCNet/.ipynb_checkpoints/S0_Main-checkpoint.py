...
if __name__ == "__main__":
    ...
    root_dir = "/data/lab/DSCNet/DSCNet_2D_opensource/"  # todo
    ...
    parser.add_argument(
        "--Tr_Image_dir",
        default="/data/lab/DSCNet/Data/test/",  # 确保这是你训练图像的实际路径
        help="the address of the train image",
    )
    parser.add_argument(
        "--Te_Image_dir",
        default="/data/lab/DSCNet/Data/test/",  # 确保这是你测试图像的实际路径
        help="the address of the test image",
    )
    parser.add_argument(
        "--Tr_Label_dir",
        default="/data/lab/DSCNet/Data/test_labels/",  # 确保这是你训练标签的实际路径
        help="the address of the train label",
    )
    parser.add_argument(
        "--Te_Label_dir",
        default="/data/lab/DSCNet/Data/test_labels/",  # 确保这是你测试标签的实际路径
